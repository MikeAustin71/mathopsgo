...
func TestNumStrDto_NewInt_01(t *testing.T) {
  ...
  numStrDtoResult, err := new(NumStrDto).NewInt(inputNumInt, inputPrecisionUint)

  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "numStrDtoResult, err := new(NumStrDto).\n"+
      "  NewInt(inputNumInt, inputPrecisionUint)\n"+
      "inputNumInt= '%v'\n"+
...
func TestNumStrDto_NewInt64Exponent_01(t *testing.T) {
  ...
  ePrefix := "TestNumStrDto_NewInt64Exponent_01"
  ...
  numStrDtoResult, err := new(NumStrDto).NewInt64Exponent(inputNumInt64, inputExponentInt)

  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "numStrDtoResult, err := new(NumStrDto).\n"+
      "  NewInt64Exponent(inputNumInt64, inputExponentInt)\n"+
      "inputNumInt64= '%v'\n"+
      "multiplicandStr= '%v'\n"+
      "Error= '%v'\n\n",
      ePrefix,
...
func TestNumStrDto_NewInt64Exponent_02(t *testing.T) {
  ...
  ePrefix := "TestNumStrDto_NewInt64Exponent_02"

  inputNumInt64 := int64(7123)
...
func TestNumStrDto_NewInt64Exponent_03(t *testing.T) {
  ...
  ePrefix := "TestNumStrDto_NewInt64Exponent_03"

  inputNumInt64 := int64(-72)
...
func TestNumStrDto_NewInt64Exponent_04(t *testing.T) {
  ...
  ePrefix := "TestNumStrDto_NewInt64Exponent_04"

  inputNumInt64 := int64(-72123)
...
func TestNumStrDto_NewInt64Exponent_05(t *testing.T) {
  ...
  ePrefix := "TestNumStrDto_NewInt64Exponent_05"
...
func TestNumStrDto_NewInt64Exponent_06(t *testing.T) {
  ...
  ePrefix := "TestNumStrDto_NewInt64Exponent_06"
