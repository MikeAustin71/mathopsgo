...
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractBigIntNumArray(
	...
	var differenceNumStr, subtrahendNumStr string
	...
	for i := 0; i < lenSubtrahends; i++ {
		...
		if err != nil {
			...
			return BigIntNum{},
				&FuncReturnError{
					...
					ErrContext: fmt.Sprintf("Error: difference.GetNumStr() failed. Cicle # %d", i),
					ErrMessage: err.Error(),
				}
		}

		bPair, err = new(BigIntPair).NewBigIntNum(difference, subtrahends[i])
		...
		if err != nil {
			...
			return BigIntNum{},
				&FuncReturnError{
					ErrPrefix:  ePrefix.String(),
					ReturnFunc: fmt.Sprintf("bPair, err := new(BigIntPair).NewBigIntNum(difference, subtrahends[%d])", i),
			...
			return BigIntNum{},
				&FuncReturnError{
					...
					ErrContext: fmt.Sprintf("bPair1= '%v'\n"+
						"bPair2= '%v'\n"+
						"Cycle No.= %v",
						differenceNumStr, subtrahendNumStr, i),
					ErrMessage: err.Error(),
				}
		}
	}
...
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractBigIntNumOutputToArray(
	...
	subtrahends []BigIntNum,
	validateSubtrahends bool,
	errPrefDto *ePref.ErrPrefixDto) (resultsArray []BigIntNum, err error) {
...
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractDecimalOutputToArray(
	...
	subtrahends []Decimal,
	validateSubtrahend bool,
	errPrefDto *ePref.ErrPrefixDto) (resultsArray []Decimal, err error) {

	bIMathSubMacrobot.lock.Lock()

	defer bIMathSubMacrobot.lock.Unlock()

	resultsArray = []Decimal{}
		...
		if err != nil {
			...
			return BigIntNum{},
				&FuncReturnError{
					...
					ErrContext: "Error converting 'subtrahend' to BigIntNum",
					ErrMessage: err.Error(),
				}
		}
...
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractIntAryOutputToArray(
	...
	subtrahends []IntAry,
	validateSubtrahend bool,
	errPrefDto *ePref.ErrPrefixDto) (resultsArray []IntAry, err error) {
...
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractINumMgrOutputToArray(
	...
	subtrahends []INumMgr,
	validateSubtrahend bool,
	errPrefDto *ePref.ErrPrefixDto) (resultsArray []INumMgr, err error) {

	bIMathSubMacrobot.lock.Lock()

	defer bIMathSubMacrobot.lock.Unlock()

	resultsArray = []INumMgr{}
...
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractNumStrArray(
		...
		return BigIntNum{},
			&FuncReturnError{
				...
				ErrContext: fmt.Sprintf("Error converting input parameter 'minuend' to BigIntNum!\n"+
					"minuend= '%v'\n"+
					"numSeps= '%v'", minuend, numSeps.String()),
				ErrMessage: err.Error(),
			}
	}
	...
	for i := 0; i < lenSubtrahends; i++ {
		...
		if validateSubtrahends {
			...
			err = bigINumSubtrahend.IsValid(ePrefix.XCpy(fmt.Sprintf("Validating 'subtrahends[%d]'", i)).String())
			...
			if err != nil {
				...
				return BigIntNum{},
					&FuncReturnError{
						...
						ErrContext: fmt.Sprintf("Error: subtrahends[%d] Failed Validation Tests.\n"+
							"subtrahends[%d]= '%v'\n"+
							"numSeps= '%v'", i, i, subtrahends[i], numSeps.String()),
						ErrMessage: err.Error(),
					}
			}
		}
		...
		if err != nil {
			...
			return BigIntNum{},
				&FuncReturnError{
					...
					ErrContext: fmt.Sprintf("'subtrahends' cycle No.= %d", i),
					ErrMessage: err.Error(),
				}
		}
...
//	  10      -      subtrahends[4] = 6      =      outputarray[4] = 4
//	  10      -      subtrahends[5] = 9      =      outputarray[5] = 1
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractNumStrOutputToArray(
	minuend string,
	validateMinuend bool,
	subtrahends []string,
	validateSubtrahends bool,
	numSeps NumericSeparatorDto,
	validateNumSeps bool,
	errPrefDto *ePref.ErrPrefixDto) (resultsArray []string, err error) {
	...
	ePrefix,
		err = ePref.ErrPrefixDto{}.NewFromErrPrefDto(
		errPrefDto,
		"bigIntMathSubtractMacrobot.subtractNumStrOutputToArray",
		"")
	...
	minuendBigINum, err := new(BigIntNum).NewNumStrWithNumSeps(minuend, &numSeps)
	...
	if err != nil {
		...
		return resultsArray,
			&FuncReturnError{
				ErrPrefix: ePrefix.String(),
				ReturnFunc: "minuendBigINum, err := new(BigIntNum).\n" +
					"  NewNumStrWithNumSeps(minuend, &numSeps)",
				ErrContext: fmt.Sprintf("Error converting input parameter 'minuend' to BigIntNum!\n"+
					"minuend= '%v'\n"+
					"numSeps= '%v'", minuend, numSeps.String()),
	...
	if validateMinuend {
		...
		err = minuendBigINum.IsValid(ePrefix.XCpy("Validating 'minuend'").String())
		...
		if err != nil {
			...
			return resultsArray,
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: "err = minuendBigINum.IsValid(\n" +
						"  ePrefix.XCpy(\"Validating 'minuend'\").String())",
					ErrContext: "Error: Input parameter 'minuend' is invalid.\n" +
						"'minuend' BigIntNum (minuendBigINum) FAILED validation tests.",
					ErrMessage: err.Error(),
				}
		}
	}

	minuendBigINumStr, err := minuendBigINum.GetNumStr()
	...
	if err != nil {
		...
		return resultsArray,
			&FuncReturnError{
				ErrPrefix:  ePrefix.String(),
				ReturnFunc: "minuendBigINumStr, err := minuendBigINum.GetNumStr()",
				ErrContext: "",
				ErrMessage: err.Error(),
			}
	}
	...
	var bigINumSubtrahend, bigINumDifference BigIntNum
	var bigInumSubtrahendNumStr string
	var bPair BigIntPair
	...
	for i := 0; i < lenSubtrahends; i++ {
		...
		bPair, err = new(BigIntPair).NewBigIntNum(minuendBigINum, bigINumSubtrahend)
		...
		if err != nil {
			...
			return []string{},
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: "bPair, err = new(BigIntPair).\n" +
						"NewBigIntNum(minuendBigINum, bigINumSubtrahend)",
					ErrContext: fmt.Sprintf("minuendBigINum= '%v'\n"+
						"bigINumSubtrahend= '%v'",
						minuendBigINumStr, bigInumSubtrahendNumStr),
					ErrMessage: err.Error(),
				}
		}

		bigINumDifference, err = new(bigIntMathSubtractNanobot).subtractBigIntPair(
			numSeps, false, &bPair, true, ePrefix)
			...
			return []string{},
				&FuncReturnError{
					...
					ErrContext: fmt.Sprintf("bPair1= '%v'\n"+
						"bPair2= '%v'\n"+
						"Cycle No.= %v",
						minuendBigINumStr, bigInumSubtrahendNumStr, i),
					ErrMessage: err.Error(),
				}
		}

		resultsArray[i], err = bigINumDifference.GetNumStr()
		...
		if err != nil {
			...
			return []string{},
				&FuncReturnError{
					ErrPrefix:  ePrefix.String(),
					ReturnFunc: fmt.Sprintf("resultsArray[%d], err = bigINumDifference.GetNumStr()", i),
					ErrContext: fmt.Sprintf("'subtrahends' cycle No.= %d", i),
					ErrMessage: err.Error(),
				}
		}
...
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractNumStrSeries(
	numSeps NumericSeparatorDto,
	validateNumSeps bool,
	minuend string,
	validateMinuend bool,
	...
	ePrefix,
		err = ePref.ErrPrefixDto{}.NewFromErrPrefDto(
		errPrefDto,
		"bigIntMathSubtractMacrobot.subtractNumStrSeries",
		"")
	...
	if validateMinuend {
		...
		if err != nil {
			...
			return difference,
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: "err = difference.IsValid(\n" +
						"  ePrefix.XCpy(\"Validating 'minuend'\").String())",
					ErrContext: "Error: Input parameter 'minuend' is invalid.\n" +
						"'minuend' BigIntNum (difference) FAILED validation tests.",
					ErrMessage: err.Error(),
				}
		}
	}
	...
	for idx, subtrahend := range subtrahends {
		...
		if err != nil {
			...
			return BigIntNum{},
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: fmt.Sprintf("bigINumSubtrahend, err := new(BigIntNum).\n"+
						"  NewNumStrWithNumSeps(subtrahend[%d], &numSeps)", idx),
					ErrContext: fmt.Sprintf("subtrahend[%d]= '%v'\n"+
						"numSeps= '%v'", idx, subtrahend, numSeps.String()),
					ErrMessage: err.Error(),
				}
		}
		...
		if validateSubtrahends {
			...
			err = bigINumSubtrahend.IsValid(ePrefix.XCpy(fmt.Sprintf("Validating 'subtrahend[%d]'", idx)).String())
			...
			if err != nil {
				...
				return BigIntNum{},
					&FuncReturnError{
						...
						ErrContext: fmt.Sprintf("Error: subtrahend[%d] Failed Validation Tests.\n"+
							"subtrahend[%d]= '%v'\n"+
							"numSeps= '%v'", idx, idx, subtrahend, numSeps.String()),
						ErrMessage: err.Error(),
					}
			}
		}
			...
			return BigIntNum{},
				&FuncReturnError{
					...
					ErrContext: fmt.Sprintf("bPair1= '%v'\n"+
						"bPair2= '%v'\n"+
						"Cycle No.= %v",
						differenceNumStr, bigInumSubtrahendNumStr, idx),
					ErrMessage: err.Error(),
				}
		}
	}
...
//	returned instance of 'difference' (type BigIntNum) will also be
//	copied from input parameter 'numSeps'.
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractNumStrDto(
	numSeps NumericSeparatorDto,
	validateNumSeps bool,
	nDtoMinuend *NumStrDto,
	validateMinuend bool,
	nDtoSubtrahend *NumStrDto,
	validateSubtrahend bool,
	errPrefDto *ePref.ErrPrefixDto) (difference BigIntNum, err error) {
	...
	if nDtoMinuend == nil {
		...
		return difference,
			&InputPtrNilError{
				ErrPrefix:     ePrefix.String(),
				ErrContext:    "",
				ParameterName: "'nDtoMinuend'",
			}
	}

	if nDtoSubtrahend == nil {

		return difference,
			&InputPtrNilError{
				ErrPrefix:     ePrefix.String(),
				ErrContext:    "",
				ParameterName: "'nDtoSubtrahend'",
			}
	}

	if validateMinuend {

		err = nDtoMinuend.IsValid(ePrefix.XCpy("Validating 'nDtoMinuend'").String())
		...
		if err != nil {
			...
			return difference,
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: "err = nDtoMinuend.IsValid(ePrefix.XCpy(\n" +
						"  \"Validating 'nDtoMinuend'\").String())",
					ErrContext: "Error: Input parameter 'nDtoMinuend' is invalid.\n" +
						"'nDtoMinuend' FAILED validation tests.",
					ErrMessage: err.Error(),
				}
		}
	}
	...
	if validateSubtrahend {
		...
		err = nDtoSubtrahend.IsValid(ePrefix.XCpy("Validating 'nDtoSubtrahend'").String())
		...
		if err != nil {
			...
			return difference,
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: "err = nDtoSubtrahend.IsValid(ePrefix.XCpy(\n" +
						"  \"Validating 'nDtoSubtrahend'\").String())",
					ErrContext: "Error: Input parameter 'nDtoSubtrahend' is invalid.\n" +
						"'nDtoSubtrahend' FAILED validation tests.",
					ErrMessage: err.Error(),
				}
		}
	}
	...
	if err != nil {
		...
		return BigIntNum{},
			&FuncReturnError{
				ErrPrefix:  ePrefix.String(),
				ReturnFunc: "nDtoMinuendNumStr, err := nDtoMinuend.GetNumStr()",
				ErrContext: "",
				ErrMessage: err.Error(),
			}
	}
	...
	if err != nil {
		...
		return BigIntNum{},
			&FuncReturnError{
				ErrPrefix:  ePrefix.String(),
				ReturnFunc: "nDtoSubtrahendNumStr, err := nDtoSubtrahend.GetNumStr()",
				ErrContext: "",
				ErrMessage: err.Error(),
			}
	}

	bPair, err := new(BigIntPair).NewNumStrDto(*nDtoMinuend, *nDtoSubtrahend)
	...
	if err != nil {
		...
		return BigIntNum{},
			&FuncReturnError{
				ErrPrefix: ePrefix.String(),
				ReturnFunc: "bPair, err := new(BigIntPair).\n" +
					"  NewNumStrDto(*nDtoMinuend, *nDtoSubtrahend)",
				ErrContext: fmt.Sprintf("nDtoMinuend= '%v'\n"+
					"nDtoSubtrahend= '%v'", nDtoMinuendNumStr, nDtoSubtrahendNumStr),
				ErrMessage: err.Error(),
			}
	}
	...
	if err != nil {
		...
		return BigIntNum{},
			&FuncReturnError{
				...
				ErrContext: fmt.Sprintf("bPair1= '%v'\n"+
					"bPair2= '%v'\n"+
					"numSeps= '%v'", nDtoMinuendNumStr, nDtoSubtrahendNumStr, numSeps.String()),
				ErrMessage: err.Error(),
			}
	}
...
//	them into numeric values.
//
//	The Numeric Separators configured for input parameter 'numSeps'
//	will be copied to the returned instance of 'difference'
//	(type BigIntNum).
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractNumStrDtoArray(
	numSeps NumericSeparatorDto,
	validateNumSeps bool,
	minuend NumStrDto,
	validateMinuend bool,
	subtrahends []NumStrDto,
	validateSubtrahend bool,
	errPrefDto *ePref.ErrPrefixDto) (difference BigIntNum, err error) {
	...
	ePrefix,
		err = ePref.ErrPrefixDto{}.NewFromErrPrefDto(
		errPrefDto,
		"bigIntMathSubtractMacrobot.subtractNumStrDtoArray",
		"")
	...
	for i := 0; i < lenSubtrahends; i++ {
		...
		bigINumSubtrahend, err = new(BigIntNum).NewNumStrDto(subtrahends[i])
		...
		if err != nil {
			...
			return BigIntNum{},
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: fmt.Sprintf("bigINumSubtrahend, err =\n"+
						"new(BigIntNum).NewNumStrDto(subtrahends[%d])", i),
					ErrContext: fmt.Sprintf("subtrahends[%d]= '%v'",
						i, subtrahendNumStr),
					ErrMessage: err.Error(),
				}
...
//	input parameter 'minuend'.
//
//	The 'result' array ([]NumStrDto) returned by this subtraction
//	operation will contain array elements with numeric separators
//	(decimal separator, thousands separator and currency symbol) which
//	have been copied from input parameter 'minuend'.
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractNumStrDtoOutputToArray(
	numSeps NumericSeparatorDto,
	validateNumSeps bool,
	minuend NumStrDto,
	validateMinuend bool,
	subtrahends []NumStrDto,
	validateSubtrahend bool,
	errPrefDto *ePref.ErrPrefixDto) (resultsArray []NumStrDto, err error) {

	bIMathSubMacrobot.lock.Lock()

	defer bIMathSubMacrobot.lock.Unlock()

	resultsArray = []NumStrDto{}
	...
	ePrefix,
		err = ePref.ErrPrefixDto{}.NewFromErrPrefDto(
		errPrefDto,
		"bigIntMathSubtractMacrobot.subtractNumStrDtoOutputToArray",
		"")
	...
	for i := 0; i < lenSubtrahends; i++ {
		...
		if err != nil {
			...
			return []NumStrDto{},
				&FuncReturnError{
					ErrPrefix: ePrefix.String(),
					ReturnFunc: fmt.Sprintf("resultsArray[%d], err = result.GetNumStrDto()",
						i),
					ErrContext: "",
					ErrMessage: err.Error(),
				}
...
//	parameter 'minuend' to the returned instance of 'difference'
//	(type BigIntNum).
func (bIMathSubMacrobot *bigIntMathSubtractMacrobot) subtractNumStrDtoSeries(
	numSeps NumericSeparatorDto,
	validateNumSeps bool,
	minuend NumStrDto,
	validateMinuend bool,
	...
	ePrefix,
		err = ePref.ErrPrefixDto{}.NewFromErrPrefDto(
		errPrefDto,
		"bigIntMathSubtractMacrobot.subtractNumStrDtoSeries",
		"")
