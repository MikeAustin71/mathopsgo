...
//
//	 If the function completes successfully, the returned
//	 'quotient' will be populated with the correct result,
//	 and 'err' will be set equal to 'nil'.
...
func (bIDivide *BigIntMathDivide) NumStrDtoModulo(
	...
	err = modulo.IsValid("Validating Final result 'modulo'")
	...
	if err != nil {
		...
		return BigIntNum{},
			&FuncReturnError{
				ErrPrefix:  ePrefix.String(),
				ReturnFunc: "err = modulo.IsValid(\"Validating Final result 'modulo'\")",
				ErrContext: "Final result 'modulo' is INVALID!",
				ErrMessage: err.Error(),
			}
	}
...
func (bIDivide *BigIntMathDivide) NumStrDtoModuloToNumStrDto(
	...
	if err != nil {
		...
		return NumStrDto{},
			&FuncReturnError{
				ErrPrefix: ePrefix.String(),
				ReturnFunc: "err = dividend.IsValid(ePrefix.XCpy(\n" +
					"\"Validadting dividend\").String())",
				ErrContext: "Input parameter 'dividend' is INVALID!",
				ErrMessage: err.Error(),
			}
	...
	if err != nil {
		...
		return NumStrDto{},
			&FuncReturnError{
				ErrPrefix: ePrefix.String(),
				ReturnFunc: "err = divisor.IsValid(ePrefix.XCpy(\n" +
					"  \"Validating divisor\").String())",
				ErrContext: "Input parameter 'divisor' is INVALID!",
				ErrMessage: err.Error(),
			}
