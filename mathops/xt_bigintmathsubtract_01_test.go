...
func TestBigIntMathSubtract_SubtractBigInts_01(t *testing.T) {
  ...
  minuendPrecisionUint, err := minuendBiNum.GetPrecisionUint()
  ...
  subtrahendPrecisionUint, err := subtrahendBiNum.GetPrecisionUint()
  ...
  result, err := new(BigIntMathSubtract).SubtractBigInts(
    bIMinuendBigInt,
    minuendPrecisionUint,
    biSubtrahendBigInt,
    subtrahendPrecisionUint)
  ...
  if err != nil {
    t.Errorf("%v\n"+
      ...
      "bIMinuendBigInt= '%v'\n"+
      "minuendPrecisionUint= '%v'\n"+
      "biSubtrahendBigInt= '%v'\n"+
      "subtrahendPrecisionUint= '%v'\n"+
      "Error= '%v'\n\n",
      ePrefix,
...
func TestBigIntMathSubtract_SubtractBigIntNumSeries_01(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "result, err := new(BigIntMathSubtract).SubtractBigIntNumSeries(\n"+
      " minuendBiNum, subtrahendAry[0], subtrahendAry[1], subtrahendAry[2],\n"+
