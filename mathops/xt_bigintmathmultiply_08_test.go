...
func TestBigIntMathMultiply_MultiplyNumStrDtoOutputToArray_02(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathMultiply).MultiplyNumStrDtoOutputToArray"+
...
func TestBigIntMathMultiply_MultiplyNumStrDtoSeries_02(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathMultiply).MultiplyNumStrDtoSeries(multiplierNumStrDto,"+
...
func TestBigIntMathMultiply_MultiplyPair_01(t *testing.T) {
  ...
  result := new(BigIntMathMultiply).MultiplyPair(bPair)
...
func TestBigIntMathMultiply_MultiplyBigIntNumByTenToPower_01(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntNum).NewNumStrWithNumSeps(baseStr, expectedNumSeps). "+
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntNum).NewNumStrWithNumSeps(tenExponentStr, alternateNumSeps). "+
