...
func TestNumStrDto_ShiftPrecisionLeft_11(t *testing.T) {
	...
	ePrefix := "TestNumStrDto_ShiftPrecisionLeft_11"
...
func TestNumStrDto_ShiftPrecisionLeft_12(t *testing.T) {

	ePrefix := "TestNumStrDto_ShiftPrecisionLeft_12"
...
func TestNumStrDto_ShiftPrecisionLeft_13(t *testing.T) {

	ePrefix := "TestNumStrDto_ShiftPrecisionLeft_13"
...
func TestNumStrDto_ShiftPrecisionLeft_14(t *testing.T) {

	ePrefix := "TestNumStrDto_ShiftPrecisionLeft_14"

	inputNumStr := "1234567890"

	inputPrecisionUint := uint(1)

	expectedNumStr := "123456789.0"
