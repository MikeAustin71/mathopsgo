...
func TestBigIntMathAdd_AddNumStr_01(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathAdd).AddNumStr(n1Str, n2Str). "+
      "Error='%v' ", err.Error())
  }
...
func TestBigIntMathAdd_AddNumStrOutputToArray_01(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathAdd).AddNumStrOutputToArray("+
...
func TestBigIntMathAdd_AddNumStrArray_01(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathAdd).AddNumStrArray(numStrAry, expNumSeps). "+
      "Error='%v' ", err.Error())
  }
...
func TestBigIntMathAdd_AddNumStrArray_02(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathAdd).AddNumStrArray(numStrAry,expectedNumSeps). "+
      "Error='%v' ", err.Error())
  }
...
func TestBigIntMathAdd_AddNumStrArray_03(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathAdd).AddNumStrArray(numStrAry). "+
      "Error='%v' ", err.Error())
  }
...
func TestBigIntMathAdd_AddNumStrDto_01(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by new(NumStrDto).NewNumStr(n1Str). "+
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathAdd).AddNumStr(AddNumStrDto(n1Dto, n2Dto)). "+
...
func TestBigIntMathAdd_AddNumStrDtoArray_01(t *testing.T) {
  ...
  for i := 0; i < lenNStrAry; i++ {
    ...
    if err != nil {
      t.Errorf("Error returned by new(NumStrDto).NewNumStr(numStrAry[i]). "+
  ...
  if err != nil {
    t.Errorf("Error returned by new(BigIntMathAdd).AddNumStrDtoArray(numStrDtoAry). "+
