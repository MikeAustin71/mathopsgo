...
//		  to the right of the decimal	place. If 'precision' contains
//	   a value less than zero, an error will be returned.
//
//		Return Values
//		=============
//
...
//	an error.
//
//	An nthRoot value of '1' will generate an error.
//
//	Input Parameters
//	================
//
...
func (ia *IntAry) GetSquareRootOfThis(maxPrecision int) (IntAry, error) {
	...
	intAry, err := nthRt.GetSquareRootIntAry(ia, maxPrecision)
	...
	if err != nil {
		...
		return IntAry{},
			&FuncReturnError{
				ErrPrefix: ePrefix.String(),
				ReturnFunc: "intAry, err := nthRt.GetSquareRootIntAry(\n" +
					"  ia, maxPrecision)",
				ErrContext: "",
				ErrMessage: err.Error(),
			}
...
//	generated.
func (ia *IntAry) SetIntAryWithIntAry(
	iAry2 []int, precision uint, signVal int) error {
	...
	return new(intAryGluon).setIntAryWithIntAry(
		ia, false, iAry2, precision, signVal, true, ePrefix)
}
...
func (ia *IntAry) SetIntAryWithIntAryObj(iAry2 *IntAry, copyBackup bool) error {
	...
	return new(intAryGluon).setIntAryWithIntAryObj(
		ia, iAry2, true, copyBackup, true, ePrefix)
}
...
func (ia *IntAry) ShiftPrecisionLeft(shiftPrecisionLeft uint) error {
	var ePrefix *ePref.ErrPrefixDto
	var err error
	...
	return new(intAryNeutron).shiftPrecisionLeft(
		ia, true, shiftPrecisionLeft, true, ePrefix)
}
