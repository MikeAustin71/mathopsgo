...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_01(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_01"
	...
	//                                  1         2         3
	//                       0.1234567890123456789012345678901234567
	expectedResultNumStr := "9.4449895520307989885751143526805"
	...
	result, resultPrecision, err :=
		fixDecNthRoot.CalculatePositiveIntegerNthRoot(
			radicand,
			radicandPrecision,
			nthRoot,
			nthRootPrecision,
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_02(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_02"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_03(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_03"
	...
	//                                  1         2         3
	//                       0.1234567890123456789012345678901234567
	expectedResultNumStr := "7.0939709447507098368744825374903"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_04(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_04"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_05(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_05"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_06(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_06"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_07(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_07"
	...
	//                                  1         2         3
	//                       0.1234567890123456789012345678901234567
	expectedResultNumStr := "2.9730030983116531418548508649862"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_08(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_08"
	...
	if err == nil {
		t.Errorf("%v\n"+
			"Expected an Error, BUT NO ERROR WAS RETURNED!\n"+
			"radicand= -78123456; nthRoot= 4\n"+
			"Even nthRoot and negative radicand should produce an error.\n\n", ePrefix)
		return
	}
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_09(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_09"
	...
	//                                   1         2         3
	//                        0.1234567890123456789012345678901234567
	expectedResultNumStr := "-2.390871799107522442017212407745"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_10(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_10"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_11(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_11"
	...
	//                                  1         2         3
	//                       0.1234567890123456789012345678901234567
	expectedResultNumStr := "0.02154434690031883721759293566519"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_12(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_12"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_13(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_13"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_14(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_14"
...
func TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_15(t *testing.T) {
	...
	ePrefix := "TestFixedDecimalNthRoot_CalculatePositiveIntegerNthRoot_15"
