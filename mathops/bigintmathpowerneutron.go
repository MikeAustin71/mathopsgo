...
func (bIMathPwrNeutron *bigIntMathPowerNeutron) bigIntNumRaiseToPositiveIntegerPower(
	...
	if validateExponent {
		...
		if exponent.bigInt == nil {
			return BigIntNum{},
				&FuncReturnError{
					ErrPrefix:  ePrefix.String(),
					ReturnFunc: "",
					ErrContext: "",
					ErrMessage: "Input parameter 'exponent' is INVALID!\n" +
						"exponent.bigInt == 'nil'\n",
				}
		}
	}
	...
	bigIBasePrecision, err := base.GetPrecisionBigInt()
	...
	if err != nil {
		...
		return BigIntNum{},
			&FuncReturnError{
				ErrPrefix:  ePrefix.String(),
				ReturnFunc: "bigIBasePrecision, err := base.GetPrecisionBigInt()",
				ErrContext: "",
				ErrMessage: err.Error(),
			}
	}
