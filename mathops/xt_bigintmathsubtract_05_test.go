...
func TestBigIntMathSubtract_SubtractPair_01(t *testing.T) {
	...
	if subtrahendPrecision > maxPrecision {
		t.Errorf("%v\n"+
			"Error: This Test Data is Corrupted\n"+
			"subtrahendPrecision > maxPrecision\n"+
			"Expected maxPrecision = '%v'\n"+
			"  Actual maxPrecision = '%v'\n\n",
			ePrefix, subtrahendPrecision, maxPrecision)
...
func TestBigIntMathSubtract_SubtractPair_02(t *testing.T) {
	...
	bPair := new(BigIntPair).NewBigIntNum(minuendBiNum, subtrahendBiNum)
