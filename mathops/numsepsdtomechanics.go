...
//	NumericSeparatorDto instance from a variadic function
//	parameter series ('primarySourceNumSeps').
//
//	If no valid NumericSeparatorDto is found in the
//	'primarySourceNumSeps' series, the alternative source
//	NumStrDto will be selected.
//
//	In the event that the alternative source NumStrDto is
//	selected and proves to be invalid, an error will be
//	returned.
func (nSepsDtoMech *numSepsDtoMechanics) selectValidNumSepInSeries(
	...
	validSelectedNumSep NumericSeparatorDto,
	err error) {
