	...
	for i := uint64(0); i < cycleLimit; i++ {
		...
		/*
			...
			return agMean, agMeanPrecision, gValue, gValuePrecision, cycles, err
				...
				if cycleNum == 7 {
					...
					fmt.Println("    aCycleValuePrecision: ", aCycleValue.GetPrecisionInt())
					fmt.Println("             gCycleValue: ", gCycleValue.GetNumStr())
					fmt.Println("    gCycleValuePrecision: ", gCycleValue.GetPrecisionInt())
					fmt.Println("-------------------------------------------------")
					...
					fmt.Println("gComPreRoundValPrecision: ", gComPreRoundValue.GetPrecisionInt())
					fmt.Println("-------------------------------------------------")
					fmt.Println("               gComValue: ", gComValue.GetNumStr())
					fmt.Println("      gComValuePrecision: ", gComValue.GetPrecisionInt())
					fmt.Println("-------------------------------------------------")
					fmt.Println("            aCycleResult: ", aCycleResult.GetNumStr())
					fmt.Println("  aCycleResult Precision: ", aCycleResult.GetPrecisionInt())
					fmt.Println("-------------------------------------------------")
					fmt.Println("            gCycleResult: ", gCycleResult.GetNumStr())
					fmt.Println("  gCycleResult Precision: ", gCycleResult.GetPrecisionInt())
					fmt.Println("=================================================")
					fmt.Println()
					return agMean, agMeanPrecision, gValue, gValuePrecision, cycles, err
		...
		*/
		...
		/*
			...
			fmt.Println("          aCycleValue: ", aCycleValue.GetNumStr())
			fmt.Println("      aCyclePrecision: ", aCycleValue.GetPrecisionInt())
			fmt.Println("          gCycleValue: ", gCycleValue.GetNumStr())
			fmt.Println("      gCyclePrecision: ", gCycleValue.GetPrecisionInt())
			fmt.Println("         aCycleResult: ", aCycleResult.GetNumStr())
			fmt.Println("aCycleResultPrecision: ", aCycleResult.GetPrecisionInt())
			fmt.Println("         gCycleResult: ", gCycleResult.GetNumStr())
			fmt.Println("gCycleResultPrecision: ", gCycleResult.GetPrecisionInt())
			fmt.Println("=================================================")
			fmt.Println()
