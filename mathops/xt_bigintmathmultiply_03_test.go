...
func TestBigIntMathMultiply_MultiplyBigIntNumSeries_01(t *testing.T) {
  ...
  multiplierBiNum, err := new(BigIntNum).NewNumStr(originalMultiplierStr)
  ...
  for i := 0; i < lenArray; i++ {
    ...
    bINumArray[i], err = new(BigIntNum).NewNumStr(originalMultiplicandStrs[i])

    if err != nil {
      t.Errorf("%v\n"+
        "Error returned by:\n"+
        "bINumArray[%d], err = new(BigIntNum).NewNumStr(originalMultiplicandStrs[%d])\n"+
...
func TestBigIntMathMultiply_MultiplyBigIntNumSeries_05(t *testing.T) {
  ...
  if err != nil {
    t.Errorf("Error returned by multiplierBiNum.SetNumericSeparatorsDto(frenchNumSeps). "+
      "Error='%v' ", err.Error())
  }
  ...
  if !expectedBigINumEqualResultBigINum {
    t.Errorf("%v\n"+
      "Error: expectedBigINum and result ARE NOT EQUAL!\n"+
...
func TestBigIntMathMultiply_MultiplyDecimal_06(t *testing.T) {
  ...
  err = iaMultiplier.SetNumericSeparatorsDto(frenchNumSeps)
  ...
  expectedDecimal, err := new(Decimal).NewNumStrWithNumSeps(originalExpectedDecimalNumStr, frenchNumSeps)
  ...
  if originalExpectedDecimalNumStr != expectedDecimalNumStr {
    t.Errorf("%v\n"+
      "Error: Unexpected Result!\n"+
      "Because  originalExpectedDecimalNumStr != expectedDecimalNumStr\n"+
      "Expected expectedDecimalNumStr = '%v'\n"+
      "  Actual expectedDecimalNumStr = '%v'\n\n",
      ePrefix, originalExpectedDecimalNumStr, expectedDecimalNumStr)
  ...
  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "multiplicandDecimalNumStr, err := \n"+
      "  multiplicandDecimal.GetNumStr()\n"+
      "Error= '%v'\n\n", ePrefix, err.Error())
    return
  }
  ...
  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "err = multiplierDecimal.\n"+
      "  SetNumericSeparatorsDto(frenchNumSeps)\n"+
      "frenchNumSeps= '%v'\n"+
      "Error= '%v'\n\n",
      ePrefix, frenchNumSeps.String(), err.Error())
    return
  ...
  // multiplierDecimal configured with frenchNumSeps
  result, err := new(BigIntMathMultiply).
    MultiplyDecimal(multiplierDecimal, multiplicandDecimal)
  ...
  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "expectedDecimalCmpResultDecimal, err :=\n"+
      "  expectedDecimal.Cmp(resultDecimal)\n"+
      "resultDecimal= '%s'\n"+
      "Error='%v'\n\n",
      ePrefix,
      resultNumStr,
  ...
  if expectedDecimalCmpResultDecimal != 0 {
    ...
    t.Errorf("%v\n"+
      "Error: Expected Decimal and Actual Result Decimal are NOT EQUAL!\n"+
      "Expected Decimal= '%s'.\n"+
      "Result Decimal  = '%s'.\n\n",
      ePrefix,
      expectedDecimalBigInt.Text(10), resultBigInt.Text(10))
  ...
  if originalExpectedDecimalNumStr != resultNumStr {
    t.Errorf("%v\n"+
      "Error: Unexpected Result!\n"+
      "Because originalExpectedDecimalNumStr != resultNumStr\n"+
      "Expected resultNumStr = '%v'\n"+
      "  Actual resultNumStr = '%v'\n\n",
      ePrefix, originalExpectedDecimalNumStr, resultNumStr)
  ...
  if originalExpectedDecimalNumStr != iaResultNumStr {
    t.Errorf("%v\n"+
      "Error: Unexpected Result!\n"+
      "Because originalExpectedDecimalNumStr != iaResultNumStr\n"+
      "Expected iaResultNumStr = '%v'\n"+
      "  Actual iaResultNumStr = '%v'\n\n",
      ePrefix, originalExpectedDecimalNumStr, iaResultNumStr)
