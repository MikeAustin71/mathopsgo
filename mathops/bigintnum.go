...
func (bNum *BigIntNum) GetNumStrDto() (NumStrDto, error) {
	...
	numStrDto, err := new(bigIntNumProton).bigIntNumGetNumStrDto(
		bNum, ePrefix)
	...
	if err != nil {
		...
		return NumStrDto{},
			&FuncReturnError{
				ErrPrefix: ePrefix.String(),
				ReturnFunc: "numStrDto, err := new(bigIntNumProton).\n" +
					"  bigIntNumGetNumStrDto(bNum, prefix)\n",
				ErrContext: "",
				ErrMessage: err.Error(),
			}
	}
...
func (bNum *BigIntNum) NewNumStrDto(nDto NumStrDto) (BigIntNum, error) {
	...
	if err != nil {
		...
		return BigIntNum{},
			&FuncReturnError{
				ErrPrefix: ePrefix.String(),
				ReturnFunc: "err = new(bigIntNumMolecule).setNumStrDto(\n" +
					"&bINum2, nDto, ePrefix)",
				ErrContext: "",
				ErrMessage: err.Error(),
			}
