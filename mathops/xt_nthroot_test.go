...
func TestNthRootOp_GetSquareRootInt32_01(t *testing.T) {
  ...
  ePrefix := "TestNthRootOp_GetSquareRootInt32_01"

  originalNumInt32 := int32(26865)

  originalNumPrecicisionInt := 1
  ...
  intAryResult, err := new(NthRootOp).GetSquareRootInt32(originalNumInt32, originalNumPrecicisionInt, calcMaxPrecision)

  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "intAryResult, err := new(NthRootOp).GetSquareRootInt32(\n"+
      "  originalNumInt32, originalNumPrecicisionInt, calcMaxPrecision)\n"+
      "originalNumInt32= '%v'\n"+
      "originalNumPrecicisionInt= '%v'\n"+
      "calcMaxPrecision= '%v'\n"+
      "Error= '%v'\n\n",
      ePrefix, originalNumInt32, originalNumPrecicisionInt, calcMaxPrecision, err.Error())
    return
  }
...
func TestNthRootOp_GetSquareRootInt64_01(t *testing.T) {
  ...
  ePrefix := "TestNthRootOp_GetSquareRootInt64_01"

  originalNumInt64 := int64(26865)
  ...
  intAryResult, err := new(NthRootOp).GetSquareRootInt64(originalNumInt64, originalNumPrecicisionInt, calcMaxPrecision)

  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "intAryResult, err := new(NthRootOp).GetSquareRootInt64(\n"+
      "  originalNumInt64, originalNumPrecicisionInt, calcMaxPrecision)\n"+
      "originalNumInt64= '%v'\n"+
      "originalNumPrecicisionInt= '%v'\n"+
      "calcMaxPrecision= '%v'\n"+
      "Error= '%v'\n\n",
      ePrefix, originalNumInt64, originalNumPrecicisionInt, calcMaxPrecision, err.Error())
    return
  }
...
func TestNthRootOp_GetSquareRootBigInt_01(t *testing.T) {
  ...
  ePrefix := "TestNthRootOp_GetSquareRootBigInt_01"

  originalNumBigInt := big.NewInt(int64(26865))
  ...
  intAryResult, err := new(NthRootOp).GetSquareRootBigInt(originalNumBigInt, originalNumPrecicisionInt, calcMaxPrecision)

  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "intAryResult, err := new(NthRootOp).GetSquareRootInt64(\n"+
      "  originalNumBigInt, originalNumPrecicisionInt, calcMaxPrecision)\n"+
      "originalNumBigInt= '%v'\n"+
      "originalNumPrecicisionInt= '%v'\n"+
      "calcMaxPrecision= '%v'\n"+
      "Error= '%v'\n\n",
      ePrefix, originalNumBigInt.Text(10), originalNumPrecicisionInt, calcMaxPrecision, err.Error())
    return
  }
...
func TestNthRootOp_GetSquareRootIntAry_01(t *testing.T) {
  ...
  ePrefix := "TestNthRootOp_GetSquareRootIntAry_01"

  originalNumStr := "2686.5"
  ...
  err := intAryOriginalNum.SetIntAryWithNumStr(originalNumStr)
  ...
  if expectedNumberStr != intAryOriginalNumNumberStr {
    t.Errorf("%v\n"+
      "Error: Number Strings DO NOT MATCH!\n"+
      "Because expectedNumberStr != intAryOriginalNumNumberStr\n"+
      "Expected intAryOriginalNumNumberStr = '%v'\n"+
      "  Actual intAryOriginalNumNumberStr = '%v'\n\n",
      ePrefix, expectedNumberStr, intAryOriginalNumNumberStr)

    return
  }

  intAryResult, err := new(NthRootOp).GetSquareRootIntAry(&intAryOriginalNum, calcMaxPrecision)

  if err != nil {
    t.Errorf("%v\n"+
      "Error returned by:\n"+
      "intAryResult, err := new(NthRootOp).GetSquareRootIntAry(\n"+
      "  &intAryOriginalNum, calcMaxPrecision)\n"+
      "intAryOriginalNum= '%v'\n"+
      "calcMaxPrecision= '%v'\n"+
      "Error= '%v'\n\n",
      ePrefix,
