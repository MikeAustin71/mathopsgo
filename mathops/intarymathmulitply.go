...
// Multiply
//
//	Multiplies intAry ia1 by intAry ia2 and stores the
//	multiplication result in intAry iaResult.
//
//	Parameters
//	==========
//
...
//	  operation, 'ia1' is the multiplicand.
//
//	'ia2'                    *IntAry
//	   Pointer to an intAry object. In this multiplication
...
//
//	'iaResult'               *IntAry
//	  Pointer to an intAry object which will be
//	  populated with the result of the multiplication
//	  operation. The multiplication operation is achieved
//	  by multiplying 'ia1' by 'ia2'.
//
//	'minimumResultPrecision' int
//	  'minimumResultPrecision' will determine the minimum number
//	  of digits computed to the right of the decimal place in
//	  the final result.
//
//	  If 'minimumResultPrecision' is set to a value of -1, all
//	  significant digits (digits greater than zero) will be returned
//	  to the right of the decimal place. Remember that the maximum
//	  number of decimal digits returned will be controlled by
//	  parameter 'maxResultPrecision'.
//
//	'maxResultPrecision' 		 int
//	  'maxResultPrecision' will determine the maximum
//	  number of digits to the right of the decimal
