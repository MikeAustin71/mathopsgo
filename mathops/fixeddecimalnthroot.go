...
func (rootCalcFacs *FixedDecNthRootCalcFactors) New() FixedDecNthRootCalcFactors {
  ...
  for i := 0; i < 10; i++ {
    ...
    calcFacs.Betas[i] = new(NthRootBeta).New(i, i)
  }
...
func (rootCalcFacs *FixedDecNthRootCalcFactors) NewCalcFacs(
  ...
  calcFacs := new(FixedDecNthRootCalcFactors).New()
...
func (fdNthRoot *FixedDecimalNthRoot) BabylonianSqrRoot(
  ...
  for cycleCnt = uint64(0); cycleCnt < calcCycles; cycleCnt++ {
    ...
    factor1, factor1Precision, errX =
      new(BigIntMathAdd).BigIntAdd(factor2, factor2Precision, factor3, factor3Precision)

    if errX != nil {

      return sqrRoot, sqrRootPrecision, cycleCnt,
        &FuncReturnError{
          ErrPrefix: ePrefix.String(),
          ReturnFunc: "factor1, factor1Precision, errX =\n" +
            "  new(BigIntMathAdd).BigIntAdd(\n" +
            "  factor2, factor2Precision, factor3, factor3Precision)",
          ErrContext: "",
  ...
  sqrRoot, sqrRootPrecision, errX =
    new(BigIntMath).RoundToMaxPrecision(xLast, xLastPrecision, maxPrecision, true)
  ...
  if errX != nil {
    ...
    return sqrRoot, sqrRootPrecision, cycleCnt,
      &FuncReturnError{
        ErrPrefix: ePrefix.String(),
        ReturnFunc: "sqrRoot, sqrRootPrecision, errX = \n" +
          "  new(BigIntMath).RoundToMaxPrecision(\n" +
          "  xLast, xLastPrecision, maxPrecision, true)",
        ErrContext: "",
        ErrMessage: errX.Error(),
      }
  }

  return sqrRoot, sqrRootPrecision, cycleCnt, nil
}
...
func (fdNthRoot *FixedDecimalNthRoot) IntegerSqrRoot(
  ...
  if radicand == nil {
    ...
    return sqrRoot, sqrRootPrecision,
      &InputPtrNilError{
        ErrPrefix:     ePrefix,
    ...
    if remainder.Cmp(bigZero) == 0 {
      ...
      return result, resultPrecision,
        &FuncReturnError{
          ErrPrefix:  ePrefix,
          ReturnFunc: "",
          ErrContext: "remainder is Zero! Invalid Entry\n",
          ErrMessage: "Cannot calculate nthRoot of a negative radicand when nthRoot is even.\n",
        }
  ...
  if maxPrecision.Cmp(bigZero) == -1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ...
        ErrMessage: "Error 'maxPrecision' is Less Than Zero!\n",
      }
  }
...
func (fdNthRoot *FixedDecimalNthRoot) CalculatePositiveFractionalNthRoot(
  ...
  if nthRtPrecisionCmpZero == 0 {
    err = fmt.Errorf(ePrefix+"\nError 'nthRootPrecision' is Zero\n"+
      "nthRoot is an integer!\n "+
      "nthRootPrecision='%v'\n", nthRootPrecision.Text(10))
    return result, resultPrecision, err
  }

  if maxPrecision.Cmp(bigZero) == -1 {
    err = fmt.Errorf(ePrefix+"\nError 'maxPrecision' is Less Than Zero!\n"+
...
func (fdNthRoot *FixedDecimalNthRoot) CalculateNegativeFractionalNthRoot(
  ...
  if radicandPrecisionZeroCmp == -1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "",
        ErrContext: fmt.Sprintf("radicandPrecision='%v'", radicandPrecision.Text(10)),
        ErrMessage: "Error: 'radicandPrecision' is Less Than Zero! ",
      }
  }
  ...
  if nthRtPrecisionCmpZero == -1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "",
        ErrContext: fmt.Sprintf("nthRootPrecision='%v'", nthRootPrecision.Text(10)),
        ErrMessage: "Error 'nthRootPrecision' is Less Than Zero!\n",
      }
  }
  ...
  if nthRtPrecisionCmpZero == 0 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ...
        ReturnFunc: "",
        ErrContext: fmt.Sprintf("nthRootPrecision='%v'", nthRootPrecision.Text(10)),
        ErrMessage: "Error 'nthRootPrecision' is Zero. nthRoot is an integer value!",
      }
  }
  ...
  if nthRtCmpZero == 0 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "nthRtCmpZero := nthRoot.Cmp(bigZero)",
        ErrContext: "nthRtCmpZero == 0",
  ...
  if nthRtCmpZero == 1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ...
        ErrMessage: "Error 'nthRoot' is positive!",
      }
  }
  ...
  if errx != nil {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix: ePrefix,
        ReturnFunc: "tempRoot, tempRootPrecision, errx :=\n" +
          "fdNthRoot.CalculatePositiveFractionalNthRoot(\n" +
          "radicand, radicandPrecision, tempNthRoot, tempNthRootPrecision,\n" +
          " fdNthRoot.maxInternalPrecision) ",
        ErrContext: "",
        ErrMessage: errx.Error(),
      }
  ...
  if radicandPrecisionZeroCmp == -1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "",
        ErrContext: fmt.Sprintf("radicandPrecision='%v'",
  ...
  if nthRtPrecisionCmpZero == -1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "",
        ErrContext: fmt.Sprintf("nthRootPrecision='%v'",
          nthRootPrecision.Text(10)),
        ErrMessage: "Error 'nthRootPrecision' is Less Than Zero!",
      }
  }
  ...
  if maxPrecision.Cmp(bigZero) == -1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "",
        ErrContext: fmt.Sprintf("maxPrecision='%v'",
          maxPrecision.Text(10)),
        ErrMessage: "Error 'maxPrecision' is Less Than Zero!",
      }
  }
  ...
  if nthRtPrecisionCmpZero == 1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ...
        ErrContext: fmt.Sprintf("nthRootPrecision='%v'",
          nthRootPrecision.Text(10)),
        ErrMessage: "Error 'nthRootPrecision' is Greater Than Zero!",
      }
  }
  ...
  if nthRtCmpZero == 0 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ...
        ReturnFunc: "",
        ErrContext: "",
        ErrMessage: "Error: INVALID INPUT!\n" +
          "'nthRoot' is Zero!",
      }
  }
...
// maximum requested precision for the present calculation. The maximum internal precision is
  ...
  if fdNthRoot.maxPrecision.Cmp(uintMax) == 1 {
    ...
    return result, resultPrecision,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "",
        ErrContext: fmt.Sprintf("Requested maxPrecision='%v'.\nMixmum uint type capacity='%v'\n",
          fdNthRoot.maxPrecision.Text(10), uintMax.Text(10)),
        ErrMessage: "Error: Requested result maximum precision exceeds maximum for uint type.",
      }
  }
  ...
  if fdNthRoot.GuessBeta(&fdNthRoot.betas[0]) == -1 {
    ...
    return -1,
      &FuncReturnError{
        ErrPrefix:  ePrefix,
        ReturnFunc: "",
        ErrContext: "if fdNthRoot.GuessBeta(&fdNthRoot.betas[0]) == -1",
        ErrMessage: "Error. 1 is negative and zero is negative",
      }
  }
...
func (fdNthRoot *FixedDecimalNthRoot) FormatCalculationConstants(
  ...
  totDigits, err := new(BigIntMath).GetMagnitude(intRadicand)

  if err != nil {

    return &FuncReturnError{
      ErrPrefix:  ePrefix,
      ReturnFunc: "totDigits, err := new(BigIntMath).GetMagnitude(intRadicand)",
      ErrContext: "",
      ErrMessage: err.Error(),
    }
  }
...
func (fdNthRoot *FixedDecimalNthRoot) GetInternalCalcFactors() FixedDecNthRootCalcFactors {
  ...
  return new(FixedDecNthRootCalcFactors).NewCalcFacs(fdNthRoot)
}
...
func (fdNthRoot *FixedDecimalNthRoot) initializeCalcFactors() {
  ...
  for i := 0; i < 10; i++ {
    fdNthRoot.betas[i] = new(NthRootBeta).New(i, i)
  }
